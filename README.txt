...
- BetterVehiclesConfig.cs: Example of ModConfig for custom mod settings;
- BetterVehiclesGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- BetterVehiclesMain.cs: Main mod class, recieves mod management and general events;
- BetterVehiclesTactical.cs: Example of ModTactical for modifying tactical level;
